...
<div id="stylized_2" class="myform">
    <form method="post" name="form" action="input_shop" enctype="multipart/form-data">
        ...
        <table>
            <tr>
                <td>
                    ...
                    <input type="text" name="input_tradingid" id="input_tradingid" value="123"/>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td>
                    ...
                    <input type="text" name="input_saletype" id="input_saletype" value=""/>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td>
                    ...
                    <input type="text" name="input_paymentmethod" id="input_paymentmethod" value=""/>
                </td>
            </tr>
            <tr>
                <td>
